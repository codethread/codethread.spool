...
Codethread is the coordination home for processes shared by Millstrand and its sibling repositories. Keep the procedure here; each repository implements it for its own layout and links back to this documentation.
