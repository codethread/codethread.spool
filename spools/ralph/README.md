...
The restart-aware client and repository tooling pin Millstrand `71c0ed3d80fcad090b74a704a8eb165a3fad996e`. Build the `mill` and `strand` tooling from that exact checkout when running a real disposable replacement-world exercise. The normal Ralph gate remains:
