...
#
# Usage:
#   spools/ralph/demo-world.sh            # build the world, print next steps
#   spools/ralph/demo-world.sh --teardown <workspace-dir>
set -euo pipefail
