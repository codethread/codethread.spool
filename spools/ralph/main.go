...
//
// This binary is the executable shipped by Codethread's Ralph spool. It remains
// a separate Go module so its deterministic tests and toolchain stay localized
// under this spool.
package main
