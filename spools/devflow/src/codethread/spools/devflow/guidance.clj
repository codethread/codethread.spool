(ns codethread.spools.devflow.guidance
  "Loader for the devflow authoring knowledge base.

  The knowledge itself lives as markdown under
  `resources/codethread/spools/devflow/guidance/`: one cohesive document per artifact
  ...
  guide with `codethread.spools.devflow/guidance` or `strand devflow guidance <key>`."
...
(defn- slurp-resource [file]
  (let [path (str "codethread/spools/devflow/guidance/" file)]
