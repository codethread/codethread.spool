(ns codethread.spools.devflow
  ...
  plan, task queue, ...) lives in `codethread.spools.devflow.guidance` and is served
  ...
  (:require [camel-snake-kebab.core :as csk]
            ...
            [codethread.spools.devflow.guidance :as guidance]
    ...
    (workflow/checkpoint :human-signoff-proposal
                         ...
                         :choices [{:key :approved
                                   ...
                                   {:key :approved-to-cards
                                    ...
                                    :next 'codethread.spools.devflow/land-proposal}
                                   {:key :revise
                                    :label "Revise"
  ...
  (workflow/workflow
    ...
    (workflow/checkpoint :handoff-card-review
                         ...
                         :choices [{:key :review
                                    ...
                                    :next 'codethread.spools.devflow/review-cards
    ...
    {:doc (str "Show the devflow workspace overview, or one artifact's full "
     ...
     {:use-when [(str "A ready step carries a devflow/guide attribute and you "
      ...
      :notes [(str "The payload is resolved live from the loaded spool on every "
                   ...
                   "(codethread.spools.devflow/guidance <key>).")]}}}})
  ...
  {:subcommands
   {"guidance" {:type :map
                :required {:operation :string
                           ...
                           ;; guidance resources by codethread.spools.devflow.guidance.
                           :guidance :string}
