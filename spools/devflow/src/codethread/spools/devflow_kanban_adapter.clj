...
(workflow/defworkflow decompose-kanban
  ...
  {:entrypoints #{:continue :call}
   :param-spec :codethread.spools.devflow/decompose-params
   :defaults {}}
  ...
  (let [params (if (map? params)
    ...
    (current/with-runtime runtime
      (workflow/register-workflow! :decompose
                                   'codethread.spools.devflow-kanban-adapter/decompose-kanban))
...
(lifecycle/defseed devflow-kanban-default
  "Make the Kanban-bound decompose route the default in this consumer world."
  {:apply 'codethread.spools.devflow-kanban-adapter/repoint-decompose-seed!})
