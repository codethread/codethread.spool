...
go -C "$go_root" vet ./...
go -C "$go_root" test ./...
# Compile tagged replacement coverage without making the normal quality gate
# start disposable Mill and Weaver processes.
go -C "$go_root" test -tags=integration -run '^$' ./...
