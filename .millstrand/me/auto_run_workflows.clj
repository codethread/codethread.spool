         ...
         (concat
            ...
            (fn [{:keys [card branch]}]
              (format/prose
               "
                 ...
                 PR ready for review. The next gates independently verify CI before the
                 selected landing or human-attention boundary.
          ...
          (if autonomous?
            ...
            [(workflow/gate
              ...
              "The verified PR now needs actual human attention.")
             (workflow/checkpoint
